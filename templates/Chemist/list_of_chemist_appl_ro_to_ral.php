 ...
 <table class="table table-bordered">
  ...
  <tbody>
      ...
      <th scope="row"><?php echo $i+1; ?></th>
         ...
         <td><a href="<?php echo $list['pdf_file'] ;?>" target="_blank" type="application/pdf" rel="alternate">View Letter</a> | <a href="<?php echo '../scrutiny/form_scrutiny_fetch_id/'.$chemisttblId[$i]['id'].'/view/'.  $list['appliaction_type'];?>">View Application</a></td> 
     </tr>
     <?php $i++; 
   } 
